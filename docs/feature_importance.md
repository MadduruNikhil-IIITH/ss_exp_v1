...
| :--- | :---: | :---: | :---: | :---: | :---: |
| `adv_ratio` | -0.3644 | -0.4397 | -0.6395 | -0.3372 | -0.1739 |
| `align_jaccard` | 0.1876 | 0.0673 | 1.6874 | 0.0136 | 0.1932 |
| `align_match_count` | 0.2887 | 0.8571 | -0.6129 | 0.5062 | 0.3462 |
| `align_ne_match` | 0.1154 | 0.7808 | 0.0348 | 0.0829 | 0.0598 |
| `align_rouge_l_recall` | 0.5275 | 0.8671 | 0.5491 | 0.6018 | 0.5387 |
| `align_sem_sim` | 1.6896 | 2.8194 | 1.6485 | 1.3099 | 0.8544 |
| `char_count` | -1.6139 | -1.3979 | -0.0778 | -1.0716 | -0.8539 |
| `comma_count` | 0.4874 | 0.6495 | 0.3467 | 0.6078 | 0.5594 |
| `discourse_addition_count` | 0.3319 | 0.4362 | 0.7881 | 0.1532 | 0.2139 |
| `flesch_kincaid_grade` | -0.1330 | -0.1833 | -0.8189 | -0.1474 | -0.3362 |
| `flesch_reading_ease` | -0.1787 | -0.3229 | -0.7023 | 0.3707 | 0.0593 |
| `noun_ratio` | -0.5226 | -0.2837 | -0.3848 | -0.4317 | -0.4180 |
| `psg_rst_s_count` | -0.3213 | 0.0000 | -1.0059 | -0.4293 | -0.2574 |
| `question_count` | -0.3002 | -0.2000 | 0.0000 | 0.0000 | -0.4523 |
| `rel_rst_depth_ratio` | 0.0270 | 0.1387 | -0.0788 | -0.4902 | -0.4538 |
| `rel_rst_n_ratio` | 0.4740 | 0.4104 | 0.2057 | 0.5043 | 0.7203 |
| `rel_surp_diff` | 0.6586 | 0.2867 | 0.4135 | 0.3184 | 0.5082 |
| `rel_surp_ratio` | -0.9989 | -0.5639 | -0.8535 | -0.6104 | -0.6146 |
| `rel_surp_sum_ratio` | -0.2652 | -0.2748 | -1.0672 | -0.5111 | -0.4311 |
| `rst_n_ratio` | -0.4412 | -0.7965 | -0.5061 | -0.3301 | -0.3791 |
| `surp_max` | -0.6099 | -0.5093 | -0.7134 | -0.4849 | -0.3652 |
| `surp_mean` | 0.5151 | 0.2867 | 0.3820 | 0.2612 | 0.3653 |
| `surp_std` | 0.5490 | 0.4923 | 0.7010 | 0.8347 | 0.5289 |
| `surp_sum` | 0.1686 | 0.3009 | 0.9405 | 0.0670 | 0.0700 |
| `title_ratio` | 0.5384 | 1.0569 | 0.5305 | 0.5958 | 0.5058 |
| `verb_ratio` | 0.3878 | 0.7789 | 0.3115 | 0.1311 | 0.1285 |
| `word_count` | 1.5199 | 0.9779 | 0.2952 | 1.2752 | 1.1044 |
